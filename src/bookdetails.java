...
public class bookdetails extends JFrame
{
    ...
    public static void main(String[]args)
    {
     ...
     bookdetails objj = new bookdetails() ;   
    }
    ...
    public bookdetails()
    {
     ...
     catch(Exception e)
     {
      ...
      JButton button3 = new JButton("ADD BOOKS") ;
      button3.setBounds(350,480,105,30) ;
      button3.setBackground(Color.white) ;
      panel.add(button3) ;
      
     JButton button4 = new JButton("BACK") ;
      button4.setBounds(350,520,105,30) ;
       ...
       public void actionPerformed(ActionEvent ae)
         {
            try
            {
               ...
               String sql = "select * from addbooks where concat(ID,NAME) like ?";
       ...
       public void actionPerformed(ActionEvent ae)
         {
             ...
             conn obj = new conn() ;
             String sql = "DELETE FROM addbooks where ID =?" ;
             ...
             dispose() ;
             bookdetails sccc = new bookdetails() ;
